...
$$
G={gjzl}\times1.1\times9.81={outG:.2f} \text{{ kN}}
$$
...
$$
T_q =1.04 \times T = {Tq_0:.2f}\text{{ kN}}
$$

2）抱杆倾斜B/3时，

$$
T_q =1.04 \times T = {Tq:.2f} \text{{ kN}}
$$
...
$$
\phi =\arctan(\frac{{B}}{{2L_2}})=\arctan(\frac{{{myTopB:.2f}}}{{2\times {myL2}}})={outPhi:.2f}\text{{ °}}
$$

$$
\phi_1 =\arctan(\frac{{B}}{{2\sqrt{{L_2^2+(B/2)^2}}}})=\arctan(\frac{{{myTopB:.2f}}}{{2 \times \sqrt{{{myL2}^2+({myTopB:.2f}/2)^2}}}})={outPhiL:.2f}\text{{ °}}
$$
